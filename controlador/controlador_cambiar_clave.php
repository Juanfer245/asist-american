...
if (!empty($_POST["btnmodificar"])) {
    if (!empty($_POST["txtclaveactual"]) and !empty($_POST["txtclavenueva"]) and !empty($_POST["textid"])) {
    ...
    <script>
                $(function notificacion() {
                    new PNotify({
                        title: "Correcto",
                        type: "success",
                        text: "La contrasenia se ha modificado correctamente",
                        styling: "bootstrap3"
                    })
                })
            </script>
    ...
    <script>
                $(function notificacion() {
                    new PNotify({
                        title: "Incorrecto",
                        type: "error",
                        text: "Error al modificar la contrasenia",
                        styling: "bootstrap3"
                    })
                })
            </script>
            ...
            <script>
                $(function notificacion() {
                    new PNotify({
                        title: "Incorrecto",
                        type: "error",
                        text: "La contrasenia actual es incorrecta",
                        styling: "bootstrap3"
                    })
                })
            </script>
